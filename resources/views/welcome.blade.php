...
<body>
    ...
    <div class="flex flex-col min-h-screen items-center bg-gray-100">
        ...
        <ul class="bg-white rounded-2xl shadow overflow-hidden divide-y divide-gray-200">
            ...
            <div class="w-200">
            <h3 class="text-2xl font-bold text-green-900 text-center my-10">Top Quiz</h3>
            <ul class="border-gray-200 border mb-20">
                <li class="p-2 font-bold">
                    <ul class="flex justify-between">
                        <li class="w-[150px]">Name</li>
                        <li class="w-[50px]">Action</li>
                    </ul>
                </li>
                @foreach ($quizData as $item)
                    <li class="even:bg-gray-200 p-2">
                        <ul class="flex">
                            <li class="w-[200px]">{{ $item->name }}</li>
                            <li class="w-[150px]">  
                                <a href="/start-quiz/{{ $item->id }}/{{str_replace(' ','-',$item->name)}}" class="text-green-500 font-bold ml-12">
                                    Attempt Quiz
                                </a>
                            </li>
                        </ul>
